...
from .models import Result, Profile, VerificationToken
...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = (
        ...
        'get_role', 'get_age', 'get_gender', 'is_verified_by_email'
    )
    list_filter = (
        'is_active', 'is_staff', 'is_superuser', 'groups',
        'profile__gender', 'profile__role'
    )
    ...
    fieldsets = (
        ...
        ('Verification', {'fields': ('is_verified_by_email',)}),
    )
...
class ProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'role', 'first_name', 'last_name', 'student_id', 'employee_id')
    list_editable = ('role',)
    list_filter = ('role',)
    search_fields = ('user__username', 'first_name', 'last_name', 'student_id', 'employee_id')
